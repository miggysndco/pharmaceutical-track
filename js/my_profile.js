function edit(action) {
  document.getElementById('name').disabled = action;
...
function updateAdminDetails() {
  ...
  if(!validateName(name.value, 'name_error'))
    ...
    if(validatePassword(password)) {
      ...
      xhttp.open("GET", "php/validateCredentials.php?action=update_admin_info&name=" + name.value + "&address=" + address.value + "&email=" + email.value + "&contact_number=" + contact_number.value + "&username=" + username.value, true);
      xhttp.send();
      edit(true);
      return true;
    }
