...
function printReport(report_title) {
  ...
  if(start_date == "" || end_date == "")
    print_content = "<div class='h3 text-center text-black'>" + report_title + " Report</div><br>" + print_content;
  else
    print_content = "<div class='h3 text-center text-black'>" + report_title + " Report Between " + start_date + " and " + end_date + "</div><br><br>" + print_content;
