...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="js/manage_invoice_trash.js"></script>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('trash', 'Invoice Trash', 'Manage Invoice Trash');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col col-md-12 table-responsive">
            <div class="table-responsive">
                ...
                <tbody id="archive_invoices_div">
                  <?php
                    require 'php/manage_invoice_trash.php';
                    showInvoices();
                  ?>
                </tbody>
            	</table>
