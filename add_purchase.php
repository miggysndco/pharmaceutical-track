    ...
    <div id="add_new_supplier_model">
      <div class="modal-dialog">
      	<div class="modal-content">
      		<div class="modal-header" style="background-color: #005EE6; color: white">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="row col col-md-12 font-weight-bold">
            ...
            <div class="col col-md-1">S. Price</div>
            <div class="col col-md-1">A. Price</div>
          ...
          <div class="row col col-md-12">
            ...
            <div class="col col-md-2 form-group">
              <button class="btn btn-primary form-control" onclick="addPurchase();">Save</button>
            </div>
            <div class="col col-md-5"></div>
          </div>
          <!-- closing button -->
